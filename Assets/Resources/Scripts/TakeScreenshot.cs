using UnityEngine;
 ...
 public class TakeScreenshot : MonoBehaviour
 {
    ...
    //  }
     ...
     public void TakeScreen(int index)
     {
             ready = false;
             ...
             string folder = filename + "\\screens";
             filename += "\\screens\\saveSlot" + index.ToString() + "." + format.ToString().ToLower();
             //SaveFileCurrent.saveScreens[index - 1] = filename;
             // PlayerPrefs.SetString("saveSlot" + index.ToString(), filename);
             PlayerPrefs.SetString("saveSlot" + index.ToString(), filename);
